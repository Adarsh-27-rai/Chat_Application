...
public class UserController {
         ...
         * Returns users whose username or displayName contains the query
         * (case-insensitive).
        ...
        public ResponseEntity<List<Map<String, String>>> searchUsers(
                ...
                List<Map<String, String>> results = userRepository.findAll().stream()
                                ...
                                .filter(u -> u.getUsername().toLowerCase().contains(lq) ||
                                                (u.getDisplayName() != null
                                                                && u.getDisplayName().toLowerCase().contains(lq)))
                                .limit(20)
                                .map(u -> Map.of(
                                                "id", u.getId(),
                                                ...
                                                "avatarColor",
                                                u.getAvatarColor() != null ? u.getAvatarColor() : "#7C3AED",
